        ...
        <div class="episodes-grid">
            <div class="episode-card">
                <div class="episode-header">
                    ...
                    <h3 class="episode-title">Episodio 1</h3>
                </div>
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">509 MB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~23 min
                      </div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/GckuT1" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
